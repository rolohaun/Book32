...
const RELEASE_VERSION = '1.2.12';

const profiles = {
  book32: {
    name: 'Book32 — 7.5 inch',
    manifest: 'manifest-update-v1.2.12.json',
    flashSize: '16MB',
  ...
  sticky: {
    ...
    manifest: 'manifest-sticky-update-v1.2.12.json',
    flashSize: '32MB',
...
async function flashSelectedDevice() {
  ...
  try {
    ...
    flashButton.lastChild.textContent = ' Flash InkDeck 1.2.12';
  }
}
